  ...
  .config(['$translateProvider', function($translateProvider) {
    $translateProvider.translations('fr-FR', {
      ...
      "disclaimer": {
        ...
        "line6": "Les speakers sélectionnés par le call for paper auront accès gratuitement aux deux jours de la conférence. Petit-déjeuner, Déjeuner, Speaker Dinner & Afterparty sont inclus dans le package.",
        ...
        "line8": "Les frais de déplacement et d'hébergement POURRAIENT être couverts par le DevFest Nantes pour les speakers sélectionnés dans le cadre de ce call for paper.",
