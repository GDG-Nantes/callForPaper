  ...
  .config(['$translateProvider', function($translateProvider) {
    $translateProvider.translations('fr-FR', {
      ...
      "disclaimer": {
        ...
        "line8": "Pour les speakers qui n'ont pas été sélectionnés, nous ouvrirons si nécessaire de nouvelles places pour permettre à ces derniers de s'inscrire.",
    ...
    $translateProvider.translations('en-US', {
      ...
      "disclaimer": {
        ...
        "line8": "For speakers who were not selected, we will open if necessary new tickets to allow them to register.",
